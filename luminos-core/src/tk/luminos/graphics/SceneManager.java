...
public class SceneManager {
	...
	public SceneManager() throws Exception {
		...
		this.input = new FrameBufferObject(Window.getInstance().getWidth(), Window.getInstance().getHeight(), true);
		this.output = new FrameBufferObject(FrameBufferObject.DEPTH_TEXTURE);
	...
	public static void resize() {
		instance.input.cleanUp();
		instance.output.cleanUp();
        instance.input = new FrameBufferObject(Window.getInstance().getWidth(), Window.getInstance().getHeight(), true);
        instance.output = new FrameBufferObject(FrameBufferObject.DEPTH_TEXTURE);
	}
