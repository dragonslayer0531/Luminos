...
public class FrameBufferObject {
     ...
     */
    public FrameBufferObject(int depthBufferType) {
    ...
    public void resolveToScreen() {
    	...
    	glBlitFramebuffer(0, 0, width, height, 0, 0, Window.getInstance().getWidth(), Window.getInstance().getHeight(), GL_COLOR_BUFFER_BIT, GL_NEAREST);
    	this.unbindFrameBuffer();
    }
