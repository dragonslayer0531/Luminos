...
import tk.luminos.gameobjects.TerrainType;
...
//**************************************************Private Methods**********************************************//
	...
	private float getInterpolatedNoise(float x, float z) {
		...
		float i1 = MathUtils.CosineInterpolation(v1, v2, fracX);
		float i2 = MathUtils.CosineInterpolation(v3, v4, fracX);
		return MathUtils.CosineInterpolation(i1, i2, fracZ);
	}
