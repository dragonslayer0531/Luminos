...
public class Matrix4 {
	...
	/**
	 * Linear transformation of {@link Vector4}
	 * 
	...
	/**
	 * Scales the top-left 3x3 matrix by a {@link Vector3}
	...
	/**
	 * Translates the upper-left 2x2 matrix by a {@link Vector2}
	 * 
	...
	/**
	 * Translates the upper-left 3x3 matrix by a {@link Vector3}
	 * 
	 * @param vec		Translation vector
	 * @param src		Source vector
	 * @param dest		Destination vector
	...
	/**
	 * Stores an array of floats to a matrix.
	 * 
	 * @param data		Data to put in matrix
	 * @return			Matrix corresponding to the data parameter
	 */
	public static Matrix4 storeFloatsInMatrix4f(float[] data) {
