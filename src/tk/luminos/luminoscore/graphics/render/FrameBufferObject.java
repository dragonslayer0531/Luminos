...
public class FrameBufferObject {
	...
	public void resolveToScreen() {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, GlobalLock.WIDTH, GlobalLock.HEIGHT, GL11.GL_COLOR_BUFFER_BIT | GL11.GL_DEPTH_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
	}
