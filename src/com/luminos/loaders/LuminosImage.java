...
import com.luminos.graphics.textures.TextureData;
...
public class LuminosImage {
	 ...
	 */
	public static LuminosImage loadImage(String file, Format format) throws IOException {
	 ...
	 * @throws IOException 	Exception for if file isn't found or cannot be handled
	 */
	private static TextureData getData(String file, Format format) throws IOException {
