...
import com.luminos.graphics.gameobjects.components.Component;
import com.luminos.graphics.input.Keyboard;
import com.luminos.graphics.input.XBOXController;
...
import com.luminos.physics.colliders.BoundingSphere;
...
public class Entity implements GameObject {
	...
	public float renderDistance = 500;
	...
	public Entity(Vector3f position, Vector3f rotation, float scale, TexturedModel tm) {
		...
		models.add(tm);
		collider = new BoundingSphere(10, this);
	}
	...
	public Entity(Vector3f position, Vector3f rotation, float scale, List<TexturedModel> models) {
		...
		this.scale = scale / 8;
		this.models = models;
		collider = new BoundingSphere(this);
	}
	...
	/**
	 * Gets the entity's bounding sphere
	 * 
	 * @return		Bounding Sphere Collider
	 */
